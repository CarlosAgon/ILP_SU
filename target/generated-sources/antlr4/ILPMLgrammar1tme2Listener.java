...
public interface ILPMLgrammar1tme2Listener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link ILPMLgrammar1tme2Parser#globalFunDef}.
	 * @param ctx the parse tree
	 */
	void enterGlobalFunDef(@NotNull ILPMLgrammar1tme2Parser.GlobalFunDefContext ctx);
	/**
	 * Exit a parse tree produced by {@link ILPMLgrammar1tme2Parser#globalFunDef}.
	 * @param ctx the parse tree
	 */
	void exitGlobalFunDef(@NotNull ILPMLgrammar1tme2Parser.GlobalFunDefContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterLoop(@NotNull ILPMLgrammar1tme2Parser.LoopContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Loop}
	 * labeled alternative in {@link ILPMLgrammar1tme2Parser#expr}.
	 * @param ctx the parse tree
	 */
	void exitLoop(@NotNull ILPMLgrammar1tme2Parser.LoopContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterVariableAssign(@NotNull ILPMLgrammar1tme2Parser.VariableAssignContext ctx);
	/**
	 * Exit a parse tree produced by the {@code VariableAssign}
	 * labeled alternative in {@link ILPMLgrammar1tme2Parser#expr}.
	 * @param ctx the parse tree
	 */
	void exitVariableAssign(@NotNull ILPMLgrammar1tme2Parser.VariableAssignContext ctx);
	/**
